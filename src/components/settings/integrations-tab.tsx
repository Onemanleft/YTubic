...
/**
 * API Integrations tab: third-party services YTubic can broadcast to.
 * Discord Rich Presence is the first; Last.fm scrobbling is the planned
 * next one (see docs/feature-roadmap.md).
 */
